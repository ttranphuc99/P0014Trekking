<%-- 
    Document   : index
    Created on : Sep 26, 2019, 6:26:24 PM
    Author     : Thien Phuc
--%>
...
<!DOCTYPE html>
<!-- saved from url=(0035)http://us-123hiking.simplesite.com/ -->
<html lang="en-US" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Front page - us-123hiking.simplesite.com</title>
        ...
        <meta property="og:url" content="http://us-123hiking.simplesite.com/">
        <meta property="og:title" content="Our Diary">
        <meta property="og:description" content="Typi non habent claritatem insitam liber. - Photo Album - Duis autem vel eum iriure dolor soluta habent. - Trekking Links - Nam liber tempor cum soluta nobis eleifend habent. - Welcome - 
              Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet do...">
        <meta property="og:image" content="http://cdn.simplesite.com/i/b3/4e/285697106401250995/i285697114341417227._szw1280h1280_.jpg">
        <meta property="og:updated_time" content="2016-06-18T11:13:43.6204839+02:00">
        ...
        <link rel="stylesheet" type="text/css" href="./resource/index/8488947.design.v26374.css">
        <link rel="canonical" href="http://us-123hiking.simplesite.com/">
                            ...
                            <div class="wrapper ">
                                <div class="content">
                                            ...
                                            <ul class="thumbnails column-article-section">
                                                <li class="span4">
                                                    <div class="img-simple span12 ">
                                                        <div class="image">
                                                            <a rel="nofollow" data-ss="imagemodal" data-href="http://cdn.simplesite.com/i/b3/4e/285697106401250995/i285697114341417227._szw1280h1280_.jpg"><img src="./resource/index/i285697114341417227._rsw480h360_szw480h360_.jpg"></a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <p>Typi non habent claritatem insitam liber.</p>
                                                </li>
                                                <li class="span4">
                                                    <div class="img-simple span12 ">
                                                        <div class="image">
                                                            <a rel="nofollow" data-ss="imagemodal" data-href="http://cdn.simplesite.com/i/b3/4e/285697106401250995/i285697114341417219._szw1280h1280_.jpg"><img src="./resource/index/i285697114341417219._rsw480h360_szw480h360_.jpg"></a>
                                                        </div>
                                                    </div>

                                                    <h4>
                                                        <a rel="nofollow" href="/P0014Treking/ImageController">Photo Album</a>
                                                    </h4>

                                                    <p>Duis autem vel eum iriure dolor soluta habent.</p>
                                                </li>
                                                <li class="span4">
                                                    <div class="img-simple span12 ">
                                                        <div class="image">
                                                            <a rel="nofollow" data-ss="imagemodal" data-href="http://cdn.simplesite.com/i/b3/4e/285697106401250995/i285697114341417210._szw1280h1280_.jpg"><img src="./resource/index/i285697114341417210._rsw480h360_szw480h360_.jpg"></a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <p>Nam liber tempor cum soluta nobis eleifend habent.</p>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <c:if test="${not empty requestScope.LIST}">
                                        <c:forEach items="${requestScope.LIST}" var="introduction">
                                            <div class="section article">
                                                <div class="content">
                                                    <div class="img-simple span12 ">
                                                        <div class="image">
                                                            <a rel="nofollow" data-ss="imagemodal" data-href="./resource/index/${introduction.image}">
                                                                <img src="./resource/index/${introduction.image}">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <c:if test="${empty requestScope.LIST}">
                                        <font color="red">Empty Introduction</font>
                                    </c:if>
                                </div>
                            </div>
                        </div>
