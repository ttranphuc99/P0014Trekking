<%-- 
    Document   : image
    Created on : Sep 26, 2019, 7:53:47 PM
    Author     : Thien Phuc
--%>
...
<!DOCTYPE html>
<!-- saved from url=(0044)http://us-123hiking.simplesite.com/411163283 -->
<html lang="en-US" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Photoalbum - us-123hiking.simplesite.com</title>
        ...
        <meta property="og:url" content="http://us-123hiking.simplesite.com/411163283">
        <meta property="og:title" content="Photo Album">
        <meta property="og:image" content="http://cdn.simplesite.com/i/b3/4e/285697106401250995/i285697114341417274._rsw360h270_szw360h270_.jpg">
        <meta property="og:image" content="http://cdn.simplesite.com/i/b3/4e/285697106401250995/i285697114341417273._rsw360h270_szw360h270_.jpg">
        <meta property="og:image" content="http://cdn.simplesite.com/i/b3/4e/285697106401250995/i285697114341417275._rsw360h270_szw360h270_.jpg">
        <meta property="og:image" content="http://cdn.simplesite.com/i/b3/4e/285697106401250995/i285697114341417278._rsw360h270_szw360h270_.jpg">
        <meta property="og:image" content="http://cdn.simplesite.com/i/b3/4e/285697106401250995/i285697114341417276._rsw360h270_szw360h270_.jpg">
        <meta property="og:image" content="http://cdn.simplesite.com/i/b3/4e/285697106401250995/i285697114341417271._rsw360h270_szw360h270_.jpg">
        <meta property="og:image" content="http://cdn.simplesite.com/i/b3/4e/285697106401250995/i285697114341417268._rsw360h270_szw360h270_.jpg">
        <meta property="og:image" content="http://cdn.simplesite.com/i/b3/4e/285697106401250995/i285697114341417269._rsw360h270_szw360h270_.jpg">
        <meta property="og:updated_time" content="2016-06-18T11:14:22.7774879+02:00">
        ...
        <link rel="stylesheet" type="text/css" href="./resource/photo/8488947.design.v26374.css">
        <link rel="canonical" href="http://us-123hiking.simplesite.com/411163283">
        <link rel="shortcut icon" href="data:image/x-icon;,">
        <script type="text/javascript" async="" src="./resource/photo/analytics.js"></script><script async="" src="./resource/photo/gtm.js"></script><script type="text/javascript" src="./resource/photo/FrontendAppLocalePage.aspx"></script>
        <script type="text/javascript" src="./resource/photo/frontendApp.min.js"></script>
                        ...
                        <div id="left" class="span9"> <!-- ADD "span12" if no sidebar, or "span9" with sidebar -->
                            <div class="wrapper photo-album photo-album-compact">
                                                    ...
                                                    <c:forEach items="${requestScope.LIST}" var="image" varStatus="st">
                                                        <c:if test="${st.index % 4 == 0}">
                                                            ...
                                                            <li class="span3">
                                                                <div>
                                                                    <div class="thumbnail">
                                                                        <a rel="nofollow" data-ss="imagemodal" data-href="./resource/photo/${image.image}">
                                ...
                                <c:if test="${empty requestScope.LIST}">
                                    <font color="red">Empty photo</font>
                                </c:if>
                            </div>
                        </div>
